...
| DERP_HOME              | false    | what to serve at the root path. It may be left empty (the default, for a default homepage), use `blank` for a blank page, or a URL to redirect to | ""                |
